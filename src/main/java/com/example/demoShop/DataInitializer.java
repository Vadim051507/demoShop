...
public class DataInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        try {
            ...
            if (userRepository.count() == 0) {
                User admin = new User();
                admin.setName("Адмін");
                admin.setEmail("admin@florist.com");
                ...
                User user = new User();
                user.setName("Тестовий користувач");
                user.setEmail("user@florist.com");
    ...
    private Product product(String name, String desc, int price, String img,
                            String category, String badge, int stock) {
